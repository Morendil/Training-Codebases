...
public class LegacyGame {
	...
	// TODO: Declan 17-May-2009 Split win logic into player and computer methods
	public int win() {
		if (playerWin())
	...
	// TODO: Declan 17-May-2009 Player win logic is identical to original
	...
	// TODO: Declan 17-May-2009 Tweaked indexes & offsets to account for 6 in a row for a computer win
	private boolean computerWin() {
		...
		for (l = 0; l < 5; l++) {
			for (j = 0; j < 10; j++) {
				...
				if (marksByAxisByPlayerForChecking[2] == 6
						|| marksByAxisByPlayerForChecking[6] == 6)
					return  true;
			}
